...
int main()
{
    ...
    {
        std::cout << "Injection method (0 - call LoadLibraryA(); 1 - manually map dll): ";
        int input;
        std::cin >> input;
        ...
        case 0:
            ...
            break;
        case 1:
            successfullyInjected = InjectByManuallyMapping(procHandle, dllPath.c_str());
            break;
        }
    ...
    { 
        ...
        std::getchar();
        std::getchar(); // stop console from immiedatly closing
    }
